...
\begin{figure}
    \centering
    \includegraphics[width=0.5\textwidth]{Figures/t2k_magnetic_horns.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{Figures/track_angle_ingrid.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{Figures/p0d.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{Figures/FGD_schematic.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.7\textwidth]{Figures/ECal_schematic.png}

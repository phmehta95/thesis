...
\begin{figure}[!htb]
    ...
    \caption[Reconstructed energy spectra after data reduction for the backgrounds and the observed data taken with 552.2 days of SK-VI data.]{Reconstructed energy spectra after data reduction for the backgrounds and the observed data taken with 552.2 days of SK-VI data. Taken from \cite{DSNBhist}, accessed on 22/03/23.}
    \label{fig:DSNB_hist}
\end{figure}

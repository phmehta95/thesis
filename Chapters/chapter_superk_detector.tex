...
\caption[Schematic of the charge-to-time converter circuit.]{Schematic of the charge-to-time converter circuit \cite{nishino_high-speed_2009}.}
    \label{fig:superkdaq}
\end{figure}
...
\caption[(a) Delayed neutron capture time from prompt event with Am/Be source. (b) Reconstructed energy from gamma rays after neutron capture.]{(a) Delayed neutron capture time from prompt event with Am/Be source. (b) Reconstructed energy from gamma rays after neutron capture. Taken from \cite{marti_evaluation_2020}.}
...
\begin{figure}
    ...
    \caption[The attenuation length of Cherenkov light measured using cosmic ray muons between March of 2020 and March of 2021.]{The attenuation length of Cherenkov light measured using cosmic ray muons between March of 2020 and March of 2021, taken from \cite{marti_evaluation_2020}. The green lines on the figure indicate the first gadolinium loading period from July 14th 2020 to August 17th 2020. }
...
\begin{figure}
    ...
    \caption[Conductivity vs. z position during Gd loading inside the inner detector.]{Conductivity vs. z position during Gd loading inside the inner detector, taken from \cite{abe_first_2021}.}
...
\begin{figure}
    ...
    \caption[Neutron capture time distribution for the Am/Be source placed at Z=0 m.]{Neutron capture time distribution for the Am/Be source placed at Z=0 m, taken from \cite{abe_first_2021}.}
    \label{fig:ambe_time}
\end{figure}

Using GEANT4 Monte Carlo simulations, the neutron capture time can be converted to a value for Gd concentration. The measured mean capture lifetime of $115 \pm 1$ \micro s corresponds to a Gd concentration value of $111 \pm 2$ ppm, consistent with the target concentration value of 0.011\%.

...
\begin{figure}[!htb]
    ...
    \caption[Fractional uncertainties of beam fluxes.]{Fractional uncertainties of beam fluxes, taken from \cite{tn415_fiacob}, for FHC mode. }
...
\begin{table}
    \centering
        ...
        \hline
        \end{array}$
        \caption[Neutrino cross section parameters.]{Neutrino cross section parameters. Taken from \cite{nu_xsec} and \cite{NIWG_xsec}.}
...
\hline
\end{tabular}
\caption[Table showing the pion final state interaction parameters in NEUT and the pion momentum range they are used in.]{Table showing the pion final state interaction parameters in NEUT and the pion momentum range they are used in, taken from \cite{tn_32}.}
...
\hline
\end{tabular}
\caption[Pion FSI/SI model parameter nominal value and variations grouped according to inelastic hadron production value.]{Pion FSI/SI model parameter nominal value and variations grouped according to inelastic hadron production value, taken from \cite{tn_32}.}
...
\caption[Left:Fraction of inelastic cross-section for hydrogen for both the ENDF-V and ENDF-VIII libraries. Right: Difference of the fraction of the inelastic cross-section between the two libraries.]{Left:Fraction of inelastic cross-section for hydrogen for both the ENDF-V and ENDF-VIII libraries. Right: Difference of the fraction of the inelastic cross-section between the two libraries. Taken from \cite{tn415_fiacob}.}
...
\caption[Left:Fraction of inelastic cross-section for $\ch{^{16}O}$ for both the ENDF-V and ENDF-VIII libraries. Right: Difference of the fraction of the inelastic cross-section between the two libraries.]{Left:Fraction of inelastic cross-section for $\ch{^{16}O}$ for both the ENDF-V and ENDF-VIII libraries. Right: Difference of the fraction of the inelastic cross-section between the two libraries. Taken from \cite{tn415_fiacob}.}
...
\caption[Left: proton-proton (neutron-neutron) cross sections, where the shaded area covers the values which are scaled by $\pm$ 30\%. Right: proton-neutron cross sections, where the shaded area covers the values which are scaled by $\pm$ 30\%.]{Left: proton-proton (neutron-neutron) cross sections, where the shaded area covers the values which are scaled by $\pm$ 30\%. Right: proton-neutron cross sections, where the shaded area covers the values which are scaled by $\pm$ 30\%. Taken from \cite{tn415_fiacob}.}
...
\begin{table}
    ...
    \begin{tabular}{||cc||}
        ...
        \hline
        \end{tabular}
\caption[Uncertainties on BONSAI output parameters.]{Uncertainties on BONSAI output parameters (taken from \cite{tn_374}).}

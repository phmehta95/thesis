...
\begin{figure}
\includegraphics[width=0.7\textwidth]{Figures/flux_uncertainty.png}
...
\begin{figure}
    \includegraphics[width=0.7\textwidth]{Figures/neutron_cross_section_endf_H.PNG}
...
\begin{figure}
    \includegraphics[width=0.7\textwidth]{Figures/neutron_cross_section_endf_O.PNG}

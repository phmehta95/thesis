...
The most recent Am/Be data was taken during the "calibration campaign" of September 2022. *insert information here on positions data was taken and the background taken with that data. When defining the efficiency of the Americium-Beryllium source, it differs from the usual definition of the neutron tagging efficiency 
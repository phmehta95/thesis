...
The two ways in which the systematic error for this analysis are estimated are either using MC re-weighting or MC regeneration.
\newline
...
\begin{figure}
    \centering
\includegraphics[width=0.8\textwidth]{Figures/flux_uncertainty.png}
...
\begin{figure}
\centering
\includegraphics[width=0.7\textwidth]{Figures/xsec_uncertainty.png}
...
\begin{figure}
\centering 
    \includegraphics[width=0.7\textwidth]{Figures/fsisi_uncertainty.png}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\textwidth]{Figures/neutron_cross_section_endf_H.PNG}
...
\begin{figure}
    \includegraphics[width=0.8\textwidth]{Figures/neutron_cross_section_endf_O.PNG}
...
\begin{figure}
    \includegraphics[width=0.7\textwidth]{Figures/pp_nn_xsec.PNG}
...
\centering
    ...
    \hline
    \text { MC statistics } & \pm 0.56 \\  
    \text { PMT gain simulation } & { }_{-0.00}^{+1.56} \\ 
    \nu \text { cross section } & \pm 0.34 \\ 
    \nu \text { beam flux } & \pm 1.00 \\ 
    \pi \text { FSI/SI } & \pm 0.42  \\ 
    \text { Nucleon FSI } & \pm 0.90  \\ 
    \text { Nucleon SI } & { }_{-8.58}^{+2.49} \\ 
    \mu \text { capture on }{ }^{16} \mathrm{O} & { }_{-0.11}\\ 
    \pi \text { capture on }{ }^{16} \mathrm{O} & { }_{-3.47}^{+0.00} \\ 
    \text { Oscillation } & \pm 0.015  \\ 
    \text { Det. resp. for } \nu & \pm 1.16 \\ 
    \end{array}$

...
\begin{table}[H]
    ...
    Water & 1.33 \\
    Glass & 1.472+3670/\lambda^{2} (where \lambda is the wavelength in nm)  \\
    Bi-alkali & n_{real} + i \dot n_{img} (where n_{real} and n_{img} are the real and imaginary parts of the complex refractive index)   \\
    Vacuum & 1.00 \\

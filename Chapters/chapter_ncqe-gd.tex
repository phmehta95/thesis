...
Figure \ref{fig:continousdiscrete} shows the continuous and discrete components of the ANNRI-Gd MC, along with data from the experiment. Figure \ref{fig:annrigdmodelcompare} shows ratio plot of data and MC for the GLG4sim model, the default Geant4 photon evaporation model and the ANNRI-Gd model: here it is clear the ANNRI-Gd model fits the data better than the other two models, especially at energies above 3500 keV. Due to the Cherenkov threshold in water Cherenkov detectors, there is a varying number of gamma rays released from thermal neutron capture on Gd which would decrease the mean visible energy release to below gadolinium's Q-value. As a result, neutron tagging efficiencies rely heavily on ensuring a precise model for the gamma ray energy spectrum. 
...
\noindent 
In line with the standard SK low energy analysis definition, this energy is simply the reconstructed energy with the 0.511 MeV electron mass omitted. The range for Erec in this variable is 3.49 MeV to 29.49 MeV - the estimated kinetic energy under the hypothesis that the event is a singular electron. The upper value for this range is chosen because the background of Michel electrons (electrons from muon decay) from muon neutrino and muon anti-neutrino charged current interactions increase but the NCQE signal decreases above 30 MeV. 
...
\begin{figure}[!htbp]
    ...
    \subfloat[]{\includegraphics[width=0.49\textwidth]{Figures/erec_compare.PNG}} \hfill
    \subfloat[]{\includegraphics[width=0.49\textwidth]{Figures/dwall_compare.PNG}} \par
    \subfloat[]{\includegraphics[width=0.49\textwidth]{Figures/effwall_compare.PNG}} \hfill
...
\begin{figure}[!htbp]
    ...
    \subfloat[]{\includegraphics[width=0.49\textwidth]{Figures/gvtx_squared.JPEG}} \label{fig:gvtx_squared} \hfill 
    \subfloat[]{\includegraphics[width=0.49\textwidth]{Figures/gdir_squared.JPEG}} \label{fig:gdir_squared} \par

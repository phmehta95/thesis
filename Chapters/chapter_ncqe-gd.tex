...
Table \ref{table:ambe_tau_chi2} shows the value of tau for each of these positions, along with the $\chi^{2}$/ndf value for the exponential fit.

\begin{table}
    $$
    \begin{array}{|l|l|l|l|l|}
    \hline \text{Position (m)} & \text {Time constant (tau) value ($\mu$ s) } & \text{$chi^{2}$/ndf} \\
    \hline \text{Centre (0,0,0)} & 114.8 \pm 2.5  & 1.01 \\
    \hline \text{(0,0,+12 )} & 118 \pm 3.5 & 1.27 \\
    \hline \text{(-12,0,0)} & 110 \pm 3.7 & 1.17 \\
    \hline
    \end{array}
    $$

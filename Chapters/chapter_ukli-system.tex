...
\begin{figure}
    ...
    \caption{Occupancy plots for the collimator optics from the UKLI November 2019 test run}
...
\begin{tabular}{||c|c|c|c|c||}
    \hline \hline UKLI Barrel Injector & $\mathrm{x}(\mathrm{cm})$ & $\mathrm{y}(\mathrm{cm})$ & $\mathrm{z}(\mathrm{cm})$ & Misalignment angle $\left({ }^{\circ}\right)$ \\
    \hline
...
\centering
\begin{tabular}{||c|c|c||}
    \hline \hline Time dispersion value $(\mathrm{ns})$ & Sigma of gaussian $(\mathrm{ns})$ & $\chi^2 / n d f$ values of scattered hits region \\
    \hline
    \hline 0 & - & 8.15 \\
    \hline 5 & - & 4.72 \\

...
\begin{figure}[!htbp]
    ...
    \subfloat[]{\includegraphics[width=0.33\textwidth]{Figures/cqv_D5_air.PNG.PNG}}\hfill
    \subfloat[]{\includegraphics[width=0.33\textwidth]{Figures/cqv_D5_water.PNG.PNG}}\hfill
    \subfloat[]{\includegraphics[width=0.33\textwidth]{Figures/CQV_HP1_air.PNG.PNG}}

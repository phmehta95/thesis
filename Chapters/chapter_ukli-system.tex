...
\begin{figure}
    ...
    \begin{subfigure}{0.5\textwidth}
        ...
        \label{sfig:PDF_coll_B1}
    \end{subfigure}\hfill
    \begin{subfigure}{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{Figures/B1_coll_cdf.png} % second figure itself
        \caption{CDF for the B1 collimator}
        \label{sfig:CDF_coll_B1}
    \end{subfigure}
    \caption{PDF for the B1 collimator (\subref{sfig:PDF_coll_B1}) and CDF (\subref{sfig:CDF_coll_B1}) for the B1 collimator }
\end{figure}
